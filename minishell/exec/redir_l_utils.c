...
/*   Updated: 2023/04/28 17:55:49 by mlamarcq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	do_redir_l(t_mini_sh *mini_sh, int i_exec)
{
	...
	if (mini_sh->sep_type && do_good_redir_l(mini_sh, i_exec) == SUCCESS && one_hr_multi_l(mini_sh) == FAIL)
	{
...
int	check_last_read(t_mini_sh *mini_sh, int i_last_read, int check, int i)
{
	if (check == 1)
	{
		if (i_last_read < mini_sh->sep_2 && mini_sh->sep_type && mini_sh->sep_type[i_last_read - 1] \
